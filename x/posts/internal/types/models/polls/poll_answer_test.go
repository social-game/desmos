...
func TestPollAnswer_Equals(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			answer:      polls.NewPollAnswer(polls.AnswerID(1), "Yes"),
			otherAnswer: polls.NewPollAnswer(polls.AnswerID(2), "Yes"),
			expEquals:   false,
		},
		{
			name:        "Different answers Text",
			answer:      polls.NewPollAnswer(polls.AnswerID(1), "Yes"),
			otherAnswer: polls.NewPollAnswer(polls.AnswerID(1), "No"),
			expEquals:   false,
		},
		{
			name:        "Equals answers",
			answer:      polls.NewPollAnswer(polls.AnswerID(1), "yes"),
			otherAnswer: polls.NewPollAnswer(polls.AnswerID(1), "yes"),
			expEquals:   true,
		},
	}
